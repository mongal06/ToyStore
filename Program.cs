    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddDbContext<ToyStoreDbContext>(options =>
                options.UseSqlServer(builder.Configuration.GetConnectionString("Server=DESKTOP-N9QU7M2\\SQLEXPRESS;Database=ToyStoreDB;Trusted_Connection=True;TrustServerCertificate=True;")));
